                    ...
                    <div class="tab-content">
                        <div class="tab-pane container active" id="login">
                            ...
                            <form class="contact_form" id="loginForm" action="{{route('frontend.auth.login.post')}}"
                                ...
                                <div class="contact-info mb-2">
                                    @php $number_one= rand(1,9) ; $number_two= rand(1,9);   @endphp
                                    <input type="text" class="form-control mb-0" name="match_logic" id="match_logic" placeholder="{{ @$number_one  }} + {{ @$number_two }} = ">
                                    <span id="match_logic-error" class="text-danger"></span>
                            ...
                            <div id="socialLinks" class="text-center socialLinks">
                            </div>
                        ...
                        <div class="tab-pane container fade" id="register">
                            ...
                            <form id="registerForm" class="contact_form"
                                ...
                                <div class="contact-info mb-2 terms">
                                    {{ html()->checkbox('terms')
                                        ->class('form-control mb-0')
                                        }} 
                                         <span>I accept <a href="{{ url('/terms-conditions') }}"> Terms and conditions</a> </span> 
                                        <div id="terms-error" class="text-danger"></div>
                                </div>
                                @if(config('access.captcha.registration'))
    ...
    <script>
        ...
        $(function () {
            ...
            $('#loginForm').on('submit', function (e) {
                ...
                if ($('#loginForm #match_logic').val() == '' ) {
                    $('#loginForm #match_logic-error').html('This field is required');
                    return false;
                }
                else{
                    
                    if ( $('#loginForm #match_logic').val() !=  '@php echo(@$number_one+@$number_two) @endphp'  ) {
                    $('#match_logic-error').html('Try Again');
                    $('#loginForm #match_logic').val('');
                    return false;
                }
                }
            ...
            $('#registerForm').on('submit', function (e) {
                ...
                if ($('#registerForm #match_logic').val() == '' ) {
                    $('#registerForm #match_logic-error').html('This field is required');
                    return false;
                }
                else{
                    
                    if ( $('#registerForm #match_logic').val() !=  '@php echo(@$number_one+@$number_two) @endphp'  ) {
                        $('#registerForm #match_logic').val('');
                        $('#registerForm #match_logic-error').html('Try Again');
                    ...
                    success: function (data) {
                        ...
                        if (data.errors) {
                            ...
                            if (data.errors.terms) {
                                $('#terms-error').html('Accept Terms and conditions');
                            }
