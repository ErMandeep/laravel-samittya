        ...
        <div class="container ">
            <div class="row main-content">
                <div class="col-md-9">
                    ...
                    @if($lesson->preview || $logged_in_user->isAdmin() || $purchased_course )
                                    ...
                                    <div class="course-details-content mt-3">
                                        <div class="video-container mb-5" data-id="{{$lesson->mediavideo->id}}">
                                            @if($lesson->mediavideo->type == 'youtube')
                                                <video  id="vid1" class="video-js vjs-default-skin"   autoplay   data-setup='{ "techOrder": ["vimeo"], "sources": [{ "type": "video/youtube", "src": "{{$lesson->mediavideo->url}}"}] } '
                                                  >
                                                  </video>
                                           ...
                                           <video  id="vid1" class="video-js vjs-default-skin"   autoplay   data-setup='{ "techOrder": ["vimeo"], "sources": [{ "type": "video/vimeo", "src": "{{ $lesson->mediavideo->url }}"}] } '
                                              >
                                              </video>
                                               <!--  <div id="player" class="js-player" data-plyr-provider="vimeo"
                                                     data-plyr-embed-id="{{$lesson->mediavideo->file_name}}"></div> -->
                                            @elseif($lesson->mediavideo->type == 'upload')
                                                <video poster="" id="vid1" class="video-js vjs-default-skin"  controls>
                    ...
                    @else
                    <div class="btn-danger" style="padding: 20px;">
...
@push('after-scripts')
    <script src="{{asset('plugins/YouTube-iFrame-API-Wrapper/youtube.min.js')}}"></script>
