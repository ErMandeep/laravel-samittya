...
@section('content')
  ...
  <section class="offer-section live_page_section">
    ...
    <section id='' class="teacher-thumbnail-section">  
        <div class="container">
          <div class="col-md-12">
        ...
        <section class="categories-tag-section">
          ...
          <div class="container">
            ...
            <div class="samitya-button mt25">
              <a href="{{ route('liveclass.alllive') }}">View All</a>
          </div>
          </div>
        </section>
        <div class="container">
