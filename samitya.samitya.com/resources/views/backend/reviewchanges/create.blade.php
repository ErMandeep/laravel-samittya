...
@section('content')
  ...
  <div class="row">
                <div class="col-12 form-group">
                    ...
                    {!! Form::text('duration', old('duration'), ['class' => 'form-control', 'placeholder' => 'Add Duration (Hrs)' ]) !!}

                </div>
                <div class="col-12 form-group">
                    {!! Form::label('max_student','Max Student' , ['class' => 'control-label']) !!}
                    {!! Form::text('max_student', old('max_student'), ['class' => 'form-control', 'placeholder' => 'Maximum number of students who can enroll in this course.' ]) !!}

                </div>
                <div class="col-12 form-group">
                    {!! Form::label('skills','Skill Levels' , ['class' => 'control-label']) !!}
                    {!! Form::text('skills', old('skills'), ['class' => 'form-control', 'placeholder' => 'A possible level with this course' ]) !!}

                </div>
                <div class="col-12 form-group">
                    {!! Form::label('language','Languages' , ['class' => 'control-label']) !!}
                    {!! Form::text('language', old('language'), ['class' => 'form-control', 'placeholder' => "Language's used for studying" ]) !!}

                </div>
                <div class="col-12 form-group">
                    {!! Form::label('video_type','Add Video' , ['class' => 'control-label']) !!}
                   {!! Form::select('video_type', ['youtube' => 'Youtube','vimeo' => 'Vimeo'],null,['class' => 'form-control', 'placeholder' => 'Select One','id'=>'video_type' ]) !!}
                   <br>
                   {!! Form::text('videolink', old('videolink'), ['class' => 'form-control', 'placeholder' => 'Add video Link' ]) !!}

                </div>
                 <!--  <div class="col-12 form-group">
                    {!! Form::label('videolink','Add video Link' , ['class' => 'control-label']) !!}
                ...
                <div class="col-12 form-group">
                    {!! Form::label('tag','Add tags' , ['class' => 'control-label']) !!}
                    {!! Form::text('tag', old('tag'), ['class' => 'form-control', 'placeholder' => 'Add multiple tags  with comma(,) ' ]) !!}
