...
<div class="col-md-3 nopadding2 form-group">
    {!! Form::label('duratxion','       ' , ['class' => 'control-label']) !!}
    {!!  Form::select('display_duration2',   array( 
                            'minute' => 'Minute(S)', 
                            'hour' => 'Hour(S)',
                            ),
                             $lesson->display_duration2 , ['class' => 'form-control' , 'name'=>'display_duration2']   );  !!}   
</div>
...
<div class="row">
                <div class="col-md-6 form-group">
                    <div class="checkbox">
                        ...
                        {{ html()->label(
                                html()->checkbox('preview', $lesson->preview ? true : false,1)->id('preview')
