        ...
        <div class="card-header">
            ...
            @can('lesson_create')
                <div class="float-right">
                    <a href="{{ route('admin.reviewlession.create') }}@if(request('course_id')){{'?course_id='.request('course_id')}}@endif"
            ...
            <div class="d-block">
                <ul class="list-inline">
                    <li class="list-inline-item">
                        <a href="{{ route('admin.reviewlession.index',['course_id'=>request('course_id')]) }}"
...
@push('after-scripts')
    <script>
        ...
        $(document).ready(function () {
            var route = '{{route('admin.reviewlession.get_data')}}';


            @php
                $show_deleted = (request('show_deleted') == 1) ? 1 : 0;
                $course_id = (request('course_id') != "") ? request('course_id') : 0;
            $route = route('admin.reviewlession.get_data',['show_deleted' => $show_deleted,'course_id' => $course_id]);
            @endphp
            ...
            $(document).on('change', '#course_id', function (e) {
                ...
                window.location.href = "{{route('admin.reviewlession.index')}}" + "?course_id=" + course_id
            });
        });
