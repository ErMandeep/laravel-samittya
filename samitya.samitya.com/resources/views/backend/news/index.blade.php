...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="page-title float-left">News</h3>
            @can('blog_create')
...
@push('after-scripts')
    <script>
        ...
        $(document).ready(function () {
            ...
            // @can('blog_delete')
            @if(request('show_deleted') != 1)
            $('.actions').html('<a href="' + '{{ route('admin.news.mass_destroy') }}' + '" class="btn btn-xs btn-danger js-delete-selected" style="margin-top:0.755em;margin-left: 20px;">Delete selected</a>');
            @endif
            // @endcan
