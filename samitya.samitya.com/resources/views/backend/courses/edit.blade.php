...
<!-- ******* -->
         ...
         <div class="free {{ @$course['free'] ? 'hide' : '' }}">
                ...
                <div class="col-2 nopadding2 form-group">
                    ...
                    {!!  Form::select('display_duration2',   array( 
                            ...
                            'hour' => 'Hour(S)',
                             ...
                             $course->display_duration2 , ['class' => 'form-control' , 'name'=>'display_duration2']   );  !!}   
