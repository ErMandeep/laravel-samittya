...
<!--             <hr>
            ...
            <div class="row">
                <div class="col-12">
                    <h4>Live Courses</h4>
                    <div class="table-responsive">
                        <table id="myliveCourseTable" class="table table-bordered table-striped ">
                            <thead>
                            <tr>
                                <th>@lang('labels.general.sr_no')</th>
                                <th>@lang('labels.backend.reports.fields.name')</th>
...
@push('after-scripts')
    <script>
        ...
        $(document).ready(function () {
            ...
            var live_course_route = '{{route('admin.reports.get_live_course_data')}}';
