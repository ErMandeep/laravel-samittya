                    ...
                    <div class="row mt-4 mb-4">
                        <div class="col">
                         ...
                         <!--    <div class="form-group row">
                            ...
                            <div class="form-group row">
                                {{ html()->label('Razorpay Payment Method')->class('col-md-3 form-control-label')->for('services.razorpay.active') }}
                                <div class="col-md-9">
                                    <div class="checkbox">
                                        {{ html()->label(
                                        ...
                                        <a class="float-right font-weight-bold font-italic"
                                           href="https://razorpay.com/docs/payment-gateway/integrations-guide/key-generation/"
                                           target="_blank">How to get Razorpay API Credentials?</a>
                                    </div>
                                    <small>
                                        <i> Enables payments in site with Razorpay </i>
                                    </small>
