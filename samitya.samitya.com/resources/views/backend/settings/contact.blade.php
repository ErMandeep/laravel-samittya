...
<!-- ********************************google captcaha ***************************** -->
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <div class="checkbox">
                                        {{ html()->label(
                                                html()->checkbox('access__captcha__contact', config('access.captcha.contact') ? true : false,1)->id('captcha_status_contact')
                                    ...
                                    <div id="captcha-credentials"
                                         class="@if(config('access.captcha.contact') == 0 || config('access.captcha.contact') == false) d-none @endif">
                                        <br>
                                        <div class="form-group row">
    ...
    <script>
       ...
       @if(config('contact_data'))
        ...
        $(document).on('submit', '#general-settings-form', function (e) {
            ...
            //============== Captcha status =============//
            $(document).on('click', '#captcha_status_contact', function (e) {
//              e.preventDefault();
