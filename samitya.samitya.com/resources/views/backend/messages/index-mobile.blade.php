            ...
            <div class="messaging">
                <div class="inbox_msg">
                    ...
                    @if(request()->has('thread'))
                        <form method="post" class="compose-reply" action="{{route('admin.messages.reply')}}" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="type_msg">
                                    <div class="input_msg_write">
                                        ...
                                        <div id="controls" class="col-sm-1">
                                            <i class="fas fa-plus-circle" id="uploadefile" data-toggle="tooltip" title="Uploade Video"></i>
                    ...
                    @endif
                    <form method="post" class="d-none compose-message" action="{{route('admin.messages.send')}}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="headind_srch bg-dark">
                            <div class="chat_people header row">
                                ...
                                <div class="col-lg-9 col-12 text-dark">
                                    {!! Form::select('recipients[]', $teachers, (request('teacher_id') ? request('teacher_id') : old('recipients')), ['class' => 'form-control select2']) !!}
                                </div>
                            </div>
                        </div>
                        <div class="mesgs">
