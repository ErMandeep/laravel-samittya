...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
                ...
                <h3 class="page-title d-inline">@lang('labels.backend.tags.title')</h3>
                    ...
                    <div class="table-responsive">
                        <!-- <div class="d-block">
                            <ul class="list-inline">
                                ...
                                |
                                <li class="list-inline-item">
                                    <a href="{{ route('admin.tags.index') }}?show_deleted=1"
                        ...
                        <table id="myTable"
                            ...
                            <tr>
                                ...
                                <th>@lang('labels.backend.tags.fields.slug')</th>
...
@push('after-scripts')
    <script>
        ...
        $(document).ready(function () {
            var route = '{{route('admin.tags.get_data')}}';
