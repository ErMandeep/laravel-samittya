        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    {{ Form::model( $student, ['route' => ['admin.offline-student.update', $student->id], 'method' => 'put'] ) }}
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-12 col-lg-4 form-group">
                            <!-- {!! Form::label('title', 'Student Name', ['class' => 'control-label']) !!} -->
                            {!! Form::email('email', old('email'), ['class' => 'form-control', 'placeholder' => 'Email id', 'required' => true , 'readonly'=> true ]) !!}
                        </div>
                        <div class="col-12 col-lg-4"></div>
                        ...
                        <div class="col-12 form-group text-center">
                            ...
                            {!! Form::submit(('Edit Student'), ['class' => 'btn mt-auto  btn-danger' ,'id' => 'submit']) !!}
                        </div>
                    </div>
