        ...
        <div class="row mt-4 mb-4">
            <div class="col">
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link " data-toggle="tab" href="#bank" role="tab" aria-controls="bank" aria-expanded="true"><i class="fas fa-bank"></i> Bank Details</a>
                    </li>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane " id="bank" role="tabpanel" aria-expanded="true">
                        @include('backend.auth.user.show.tabs.bankdetails')
                    </div>
