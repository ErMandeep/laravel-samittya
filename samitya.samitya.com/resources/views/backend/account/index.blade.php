                ...
                <div class="card-body">
                    <div role="tabpanel">
                        <ul class="nav nav-tabs" role="tablist">
                            ...
                            <li class="nav-item">
                                <a href="#bank" class="nav-link" aria-controls="bank" role="tab" data-toggle="tab">Bank Details</a>
                            </li>
                            @endif
                        </ul>
                        <div class="tab-content">
                            ...
                            <div role="tabpanel" class="tab-pane fade show pt-3" id="bank" aria-labelledby="bank-tab">
                                @include('backend.account.tabs.bank')
                            </div><!--tab panel profile-->
