...
<div class="row">
    <div class="col">
        <div class="form-group">
            {{ html()->label(__('Year of Birth'))->for('Year of Birth') }}
...
<input type="radio"  id="option1" name="gender" value="male"  {{ ($logged_in_user->gender=="male")? "checked" : "" }} >Male</label>

<input type="radio" id="option2" name="gender" value="female" {{ ($logged_in_user->gender=="female")? "checked" : "" }} >Female</label>
            </div>
        </div><!--form-group-->
    </div><!--col-->
</div><!--row-->
...
<div class="row">
    <div class="col">
        <div class="form-group">
            {{ html()->label(__('Software'))->for('Software') }}
            <div>
                
<input type="radio" id="option4" name="software" value="skype" {{ ($logged_in_user->software=="skype")? "checked" : "" }} >Skype</label>

<input type="radio"  id="option3" name="software" value="zoom"  {{ ($logged_in_user->software=="zoom")? "checked" : "" }} >Zoom</label>
            </div>
        </div><!--form-group-->
    </div><!--col-->
</div><!--row-->
...
<div class="row">
    <div class="col">
        <div class="form-group">
            {{ html()->label(__('Facebook Profile'))->for('Facebook Profile') }}
...
<div class="row">
    <div class="col">
        <div class="form-group">
            {{ html()->label(__('Instagram Profile'))->for('Instagram Profile') }}

            {{ html()->text('instagramurl')
                ->class('form-control')
...
<div class="row">
    <div class="col">
        <div class="form-group">
            {{ html()->label(__('Youtube Channel'))->for('Youtube Channel') }}

            {{ html()->text('youtubeurl')
                ->class('form-control')
