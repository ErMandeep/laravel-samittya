...
@section('content')
    {{ html()->modelForm($teacher, 'PATCH', route('admin.supervisor.update', $teacher->id))->class('form-horizontal')->acceptsFiles()->open() }}
                ...
                <div class="col-12">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10 form-group">
                            {!! Form::select('state_id', $states,  ($supervisor->state_id) ? $supervisor->state_id : old('state_id'), ['class' => 'form-control js-example-placeholder-single select2 ', 'id' => 'state_id']) !!}
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10 form-group">
                            {!! Form::select('city_id', $city,  ($supervisor->city_id) ? $supervisor->city_id : old('city_id'), ['class' => 'form-control js-example-placeholder-single select2 ', 'id' => 'city_id']) !!}
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10 form-group">
                            {!! Form::select('branch_id', $branch,  ($supervisor->branch_id) ? $supervisor->branch_id : old('branch_id'), ['class' => 'form-control js-example-placeholder-single select2 ', 'id' => 'branch']) !!}
                        </div>
                    </div>
