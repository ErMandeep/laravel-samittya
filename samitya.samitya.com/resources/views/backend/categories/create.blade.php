            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-12 col-lg-4 form-group">
                    {!! Form::label('parent_id', trans('labels.backend.categories.fields.parent_id'), ['class' => 'control-label']) !!}
                    {!! Form::select('parent_id', $categories,  (request('parent_id')) ? request('parent_id') : old('parent_id'), ['class' => 'form-control js-example-placeholder-single select2 ', 'id' => 'parent_id']) !!}
