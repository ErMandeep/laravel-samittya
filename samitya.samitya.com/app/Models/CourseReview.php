...
class CourseReview extends Model
{
    ...
    protected $fillable = ['category_id', 'title', 'slug', 'description', 'price', 'course_image', 'start_date', 'published', 'featured', 'trending', 'popular', 'meta_title', 'meta_description', 'meta_keywords','display_duration','skills_level','language_used','videolink','sub_duration', 'downloadable_files', 'reviewchanges','premium','budget'];
            ...
            if (auth()->user()->hasRole('teacher')) {
                static::addGlobalScope('filter', function (Builder $builder) {
                    $builder->whereHas('teachers', function ($q) {
                        $q->where('review_user.user_id', '=', auth()->user()->id);
                    });
                });
            }
        }
