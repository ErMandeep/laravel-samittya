...
class Course extends Model
{
    ...
    protected $fillable = ['category_id', 'title', 'slug', 'description', 'price', 'course_image', 'start_date', 'published', 'featured', 'trending', 'popular', 'meta_title', 'meta_description', 'meta_keywords','display_duration','skills_level','language_used','videolink','sub_duration', 'downloadable_files', 'reviewchanges', 'course_id', 'sub_price_1', 'sub_price_2', 'sub_price_3', 'sub_month_1', 'sub_month_2', 'sub_month_3','premium','budget', 'free', 'requirement'];
    ...
    {
        return $this->belongsToMany(User::class, 'review_user')->withPivot('user_id');
    }
