...
class News extends Model
{
    ...
    {
        return $this->belongsTo(News::class, 'user_id')->withTrashed();
    }
    ...
    public function downloadableMedia()
    {
        ...
        return $this->morphMany(News::class, 'model')
    ...
    public function mediaVideo()
    {
        ...
        return $this->morphOne(News::class, 'model')
            ->whereIn('type', $types);
    ...
    {
        return $this->hasMany(NewsMedia::class,'model_id');
    }
