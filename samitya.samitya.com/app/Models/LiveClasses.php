...
class LiveClasses extends Model
{
    ...
    {
        return $this->belongsToMany(User::class, 'live_class_user')->withPivot('user_id');
    }
    ...
    {
        return $this->belongsToMany(User::class, 'live_class_student')->withTimestamps()->withPivot(['rating']);
    }
