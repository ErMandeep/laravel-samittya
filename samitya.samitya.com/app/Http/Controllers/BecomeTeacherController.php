...
class BecomeTeacherController extends Controller
{
        ...
        public function index()
    {
        ...
        $users = User::all();
        return view('admin.approveteacher.index', compact('users'));
    }
    ...
    public function all()
    {
        ...
        return view( $this->path.'.becometeacher.index', compact('courses', 'user','purchased_courses', 'recent_news','featured_courses'));
    }
