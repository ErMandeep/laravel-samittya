...
class UserRepository extends BaseRepository
{
    ...
    public function newrole($paged = 25, $orderBy = 'created_at', $sort = 'desc') : LengthAwarePaginator
    {
    ...
    public function update(User $user, array $data) : User
    {
      ...
      // echo "<pre>";  print_r($data['roles']);die("hjhhjhjh");
            ...
            if ($user->update([
                ...
                // Add selected roles/permissions
      // echo "<pre>";  print_r($data['permissions']);die("hjhhjhjh");
                $user->syncRoles($data['roles']);
                $user->syncPermissions($data['permissions']);
    ...
    public function approve(User $user, array $data) : User
    {
      ...
      // echo "<pre>";  print_r($role);die("hjhhjhjh");
