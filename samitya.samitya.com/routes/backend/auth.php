...
Route::group([
    ...
    Route::group(['namespace' => 'User'], function () {
         ...
         * User CRUD
         */
        Route::get('users', [UserController::class, 'approve'])->name('approve.index');
        ...
        Route::get('/', [UserController::class, 'newupdate'])->name('user.newupdate');
        Route::get('notapprove/', [UserController::class, 'notapprove'])->name('user.notapprove');
         });
        Route::group(['prefix' => 'user/{user}'], function () {
            ...
            Route::patch('edit/', [UserController::class, 'approve'])->name('user.approve');
