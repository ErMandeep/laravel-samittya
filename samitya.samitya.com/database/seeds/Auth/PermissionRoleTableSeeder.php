...
class PermissionRoleTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $permissions = [
            ...
            ['id'=> 73, 'name'=> 'tags_access',],

            ['id'=>74 , 'name'=>'live_class_access'],
            ['id'=>75 , 'name'=> 'live_class_create' ],
            ['id'=>76 , 'name'=> 'live_class_edit' ],
            ['id'=>77 , 'name'=> 'live_class_view'],
            ['id'=>78 , 'name'=> 'live_class_delete'],
